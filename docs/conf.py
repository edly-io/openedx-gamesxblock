...
"""
openedx-gamesxblock documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx-gamesxblock',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/edly-io/openedx-gamesxblock",
...
#
# html_title = 'openedx-gamesxblock v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'openedx-gamesxblock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_gamesxblock'),
                os.path.join(root_path, 'openedx_gamesxblock/migrations')])
