#!/usr/bin/env python
"""
Package metadata for openedx_gamesxblock.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_gamesxblock', '__init__.py')
...
setup(
    name='openedx-gamesxblock',
    version=VERSION,
    description="""openedx-gamesxblock""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Muhammad Faraz Maqsood',
    author_email='faraz.maqsood@arbisoft.com',
    url='https://github.com/edly-io/openedx-gamesxblock',
    packages=find_packages(
        include=['openedx_gamesxblock', 'openedx_gamesxblock.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        'xblock.v1': [
            'openedx_gamesxblock = openedx_gamesxblock:OpenedxGamesXBlock',
        ]
    },
    package_data=package_data("openedx_gamesxblock", ["static", "public"]),
